...
clearly map to one of the named profiles, that's a signal to either add a profile or reconsider the
company.*
...
- **Priority 1:** dream targets — actively pursue and network into
- **Priority 2:** strong fit — pursue when a relevant role opens
- **Priority 3:** opportunistic — apply if a great role appears

---

## Profile 1 — [Name, matching candidate-profile.md]

### [Company] — Priority [1/2/3]
...
*No companies yet. `setup-jobsearch` seeds a starter list here (Step 4c) during Guided setup; the
job-discovery skill adds stubs as you choose roles to pursue.*
